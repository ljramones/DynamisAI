...
## TLDR
`dynamis-ai-demo` is the runnable showcase for the full DynamisAI stack. It wires core, cognition, perception, memory, planning, navigation, voice, social, crowd, and tools into CLI and JavaFX entry points. Without this module, integration behavior is visible only through unit tests. With it, contributors can validate end-to-end runtime behavior quickly.
...
<dependency>
    ...
    <artifactId>dynamis-ai-demo</artifactId>
